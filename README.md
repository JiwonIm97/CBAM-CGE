...
본 프로젝트는 글로벌 CGE 모형을 이용하여 탄소국경조정제도(Carbon Border Adjustment Mechanism, CBAM)의 도입 효과와 CBAM 세수의 환류 방식에 따른 경제적 영향을 분석하기 위한 모형이다.

본 모형은 기준 시나리오와 CBAM 도입 시나리오를 분리하여 실행하며, CBAM 세수를 재생에너지, 노동, 가계 등 다양한 경로로 환류할 수 있도록 구성하였다.
